...
This project is indexed by GitNexus as **AI-Campaing-Studio** (17789 symbols, 26758 relationships, 256 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
