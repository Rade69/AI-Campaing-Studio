...
This project is indexed by GitNexus as **AI-Campaing-Studio** (15401 symbols, 22716 relationships, 167 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
