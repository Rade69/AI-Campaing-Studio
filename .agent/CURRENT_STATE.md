...
| ACS-P0-004 | **REJECTED round 2 (Codex) — BF-4, fix round 2 u toku, NE MERGE** | Crush | Codex, Claude | HEAD i dalje `6a2bd79`. BF-1/2/3 potvrđeno zatvoreni. Novi nalaz **BF-4**: `raw.get("formats") or []` tretira SVAKI falsy scalar (`False`, `""`, `0`) kao `None`, zaobilazeći type-check koji dolazi poslije — `formats: false` uz `supported_formats: []` prolazi bez `RegistryError`. Klasična `or`-za-default zamka. Koordinator reprodukovao nezavisno. Fix round 2 brief: `agent_reports/2026-08-31-ACS-P0-004-fix-round2-brief.md` — zamijeniti `or []` sa eksplicitnim `is None` check-om prije type-check-a. |
